...
if(strlen($_POST['nome']) == 0){
	...
	$sql_query = mysqli_query($conn,$sql_code) or die ("falha na exe" . mysqli_error);
...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex">
        <a href="form_usuario.php">Login</a>
      </form>
    </div>
  </div>
</nav>
  ...
  <input type="text" class="form-control" placeholder="Nome" name="nome" aria-label="Username" aria-describedby="basic-addon1" required>
</div>
